...
#     • Has either whitespace before it or the end of the string (match either $ or what's called a positive
# lookahead). The syntax for the end of the RegEx might look something like "($|(?=\s))"
#
# Input:
# 1 -1 1s 123 s-s -123 _55_ _f 123.456 -123.456
