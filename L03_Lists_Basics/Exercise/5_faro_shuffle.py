...
for shuffle in range(number_of_shuffles):  # follow how many shuffle we will have
    final_deck = []
    middle_of_deck = len(deck_of_cards) // 2  # finding middle of deck
    left_part = deck_of_cards[0:middle_of_deck]  # divide deck on two parts
